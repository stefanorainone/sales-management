...
async function testCompleteFlow() {
  console.log('🚀 COMPLETE FLOW TEST - Simplified\n');
  ...
  try {
    ...
    // ============================================================================
    console.log('📱 STEP 2: Generate Tasks for Seller\n');
    ...
    console.log('   ✅ Screenshot: simple-03-ai-tasks-page.png');

    // Click on a seller (Aya Ftissi)
    console.log('   → Clicking on seller "Aya Ftissi"...');
    ...
    if (!sellerClicked) {
      console.log('   ⚠️  Could not find Aya Ftissi, trying first seller button...');
      await page.evaluate(() => {
    ...
    console.log('   ✅ Seller selected: Aya Ftissi\n');

    // Enter text in the prompt field
    console.log('   → Entering custom prompt for AI...');
    ...
    console.log('   → Clicking "Genera Task AI" button...');
    ...
    if (generateBtn) {
      ...
      console.log('   ⏳ Waiting 35 seconds for AI to generate tasks...\n');
      ...
      console.log('\n   ✅ Screenshot: simple-05-tasks-generated.png');
      ...
      if (tasksGenerated) {
        console.log('   ✅ AI generated suggested tasks\n');

        // Click "Conferma Tutti" button to save all tasks
        console.log('   → Confirming all generated tasks...');
        ...
        if (confirmed) {
          ...
          page.on('dialog', async dialog => {
            console.log(`   → Accepting confirmation dialog: "${dialog.message().substring(0, 50)}..."`);
            await dialog.accept();
          });

          await sleep(2000);
          console.log('   ✅ Tasks confirmed and saved to Firestore\n');
      ...
      console.log(`   → Logging in as Aya Ftissi: ${sellerLoginEmail}`);
      ...
      // ============================================================================
      console.log('📱 STEP 4: Check Tasks on /today Page\n');

      await page.goto(`${PROD_URL}/today`, { waitUntil: 'networkidle2' });
      console.log('   ⏳ Waiting for briefing to load...');
      await sleep(8000);

      await page.screenshot({ path: 'test-results/simple-07-today-page.png', fullPage: true });
      console.log('   ✅ Screenshot: simple-07-today-page.png');
      ...
      const tasksInfo = await page.evaluate(() => {
        ...
        console.log(`   → Found ${tasksInfo.initButtonsCount} "Inizia" buttons`);
        ...
        if (tasksInfo.hasInitButtons) {
          ...
          if (taskOpened) {
            ...
            // ============================================================================
            console.log('📱 STEP 5: Verify Expected Output Format & Upload Section\n');
            ...
            console.log(`      ✓ "OBBLIGATORIO" text: ${verificationResults.hasOBBLIGATORIO ? '✅ YES' : '❌ NO'}`);
            console.log(`      ✓ "DOCUMENTO DA CARICARE": ${verificationResults.hasDocumentoDaCaricare ? '✅ YES' : '❌ NO'}`);
            console.log(`      ✓ "Carica Risultati": ${verificationResults.hasCaricaRisultati ? '✅ YES' : '❌ NO'}`);
            console.log(`      ✓ File input present: ${verificationResults.hasFileInput ? '✅ YES' : '❌ NO'}`);
            console.log(`      ✓ Red sections: ${verificationResults.redSections} ${verificationResults.redSections > 0 ? '✅' : '❌'}`);
            ...
            console.log(`\n      Overall: ${allTextVisible ? '✅ All text is visible' : '⚠️  Some text may be white'}`);
            ...
            console.log('   ✅ Screenshot: simple-09-upload-section.png');

            // ============================================================================
            // STEP 6: TEST VALIDATION
            // ============================================================================
            console.log('\n📱 STEP 6: Test Validation (Complete Without File)\n');
            ...
            // Try to complete
            console.log('   → Attempting to complete task without file...');
            ...
            if (alertShown) {
              console.log(`   ✅ VALIDATION WORKS! Alert shown:`);
              console.log(`      "${alertMessage.substring(0, 120)}..."`);
            } else {
              console.log('   ⚠️  No alert - validation may not be working');
            }

            await page.screenshot({ path: 'test-results/simple-10-validation-test.png', fullPage: false });
            console.log('   ✅ Screenshot: simple-10-validation-test.png');
            ...
            console.log('  2. ✓ Generate tasks for seller');
            console.log('  3. ✓ Login as seller');
            console.log('  4. ✓ View tasks on /today');
            console.log('  5. ✓ Open task modal');
            console.log('  6. ✓ Verify expectedOutputFormat section');
            console.log('  7. ✓ Verify file upload section');
            console.log('  8. ✓ Verify text visibility');
            console.log('  9. ✓ Test validation\n');

            console.log('📊 Verification Results:');
            console.log(`  - expectedOutputFormat visible: ${verificationResults.hasDocumentoDaCaricare ? '✅' : '❌'}`);
            console.log(`  - Upload section visible: ${verificationResults.hasFileInput ? '✅' : '❌'}`);
            console.log(`  - Red warning sections: ${verificationResults.redSections > 0 ? '✅' : '❌'} (${verificationResults.redSections} found)`);
            console.log(`  - Text color correct: ${allTextVisible ? '✅' : '❌'}`);
            console.log(`  - Validation works: ${alertShown ? '✅' : '❌'}\n`);

            console.log(`🎯 FINAL RESULT: ${allChecksPassed ? '✅ ALL CHECKS PASSED!' : '⚠️  Some checks failed'}\n`);
