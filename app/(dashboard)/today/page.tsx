            ...
            <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
              ...
              <div className="space-y-2">
                {todayCompletedTasks.map((task) => (
                  <div
                    key={task.id}
                    className="flex items-start sm:items-center gap-2 sm:gap-3 p-2.5 sm:p-3 bg-green-50 border border-green-200 rounded-lg"
                  >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <button
                        ...
                        className="px-2 py-1 text-xs bg-white border border-green-300 text-green-700 rounded hover:bg-green-100 transition-colors"
                      >
                        👁️ Dettagli
                      </button>
                    </div>
